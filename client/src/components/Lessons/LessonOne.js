  ...
  return (
    <div className='relative flex justify-center min-h-screen pt-12 lg:64 px-8'>
      <div>
        ...
        <img className='w-48 h-auto' src="https://media.istockphoto.com/vectors/whole-music-note-icon-vector-id1225831908?k=20&m=1225831908&s=612x612&w=0&h=vfPETPVCbnJrS7LvNNmiOxpabsKeLZutJUs0WLpD1G0=" alt="A Single Whole Note"></img>
        <br></br>
        <p className='text-xl text-center'>
        ...
        <img className='w-48 h-auto' src="https://openclipart.org/image/800px/92875" alt="A Single Quarter Note"></img>
        <br></br>
        <p className='text-xl text-center'>
