    ...
    <div className="relative flex justify-center min-h-screen pt-12 lg:64 px-8 bg-gray-700 text-white">
      <div>
        <h1 className="text-6xl font-bold styleMe leading-none lg:leading-snug home-name">
          Types of Rests: Whole Rest, Half Rest, and Quarter Rest
        </h1>
        <br></br>
        ...
        <img
          ...
          src="https://suzanstroud.com/wp-content/uploads/2019/02/whole-rest.jpg"
          alt="A Whole Rest"
        ></img>
        <br></br>
        <p className="text-xl text-center">
        ...
        <img
          className="w-48 h-auto"
          src="https://suzanstroud.com/wp-content/uploads/2019/02/half-rest.jpg"
          alt="A Half Rest"
        ></img>
        <br></br>
        <p className="text-xl text-center">
